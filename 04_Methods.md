# Methods: Deterministic Beam Model and PyElastica Simulations
...
For full 3D simulations, we utilize \texttt{PyElastica}~(pyelastica_zenodo, 2023; gazzola2018forward, 2018), an open-source Python implementation of Cosserat rod theory. The spine is modeled as a Cosserat rod with the following specifications:
